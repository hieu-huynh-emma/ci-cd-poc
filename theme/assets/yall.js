...
function r(e, o) {
  for (const t of n) t in e.dataset && (e.setAttribute(t, e.dataset[t]), e.classList.contains(o) && e.classList.remove(o));
}
  ...
  if (!0 === o && !1 === t) {
      ...
      (e) => {
        for (const o of e)
          if (o.isIntersecting || o.intersectionRatio) {
            const { target: e } = o;
            s(e, r, i, c), y.unobserve(e), (v = v.filter((o) => o != e)), 0 === v.length && !1 === d && y.disconnect();
          }
      },
      { rootMargin: `${a}px 0%` },
    );
    ...
    d &&
      new MutationObserver(() => {
        ...
        for (const r of n) !1 === v.includes(r) && (v.push(r), e(r, l), !0 === o && !1 === t && y.observe(r));
