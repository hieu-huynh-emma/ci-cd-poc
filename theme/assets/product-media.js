    ...
    class ProductMedia extends CustomElement {
        ...
        mounted() {
            ...
            $("product-media").ready(async () => {
                ...
                const mainElm = this.querySelector(".main-carousel .splide");
                if(!mainElm) {
                    return;
                }
                const main = new Splide(mainElm, {
                    type: "fade",
                    pagination: false,
                    arrows: false,
                    height: "100%",
                ...
                const thumbnailsElm = this.querySelector(".thumbnail-carousel");
                if(!thumbnailsElm) {
                    return;
                }
                const thumbnails = new Splide(thumbnailsElm, {
                    mediaQuery: "min",
                    fixedWidth: 80,
                    gap: 8,
                    rewind: true,
