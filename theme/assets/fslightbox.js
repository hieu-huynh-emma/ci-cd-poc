!function(e, t) {
  ...
  return function(e) {
    ...
    var o, i = "fslightbox-", r = "".concat(i, "styles"), s = "".concat(i, "cursor-grabbing"),
      ...
      p = "".concat(f, "-container"), h = "".concat(i, "fade-in"), m = "".concat(i, "fade-out"), g = h + "-strong",
      v = m + "-strong", b = "".concat(i, "opacity-"), x = "".concat(b, "1"), y = "".concat(i, "source");
    ...
    function H(e) {
      var t = e.collections, n = t.sourceLoadHandlers, o = t.sourcesRenderFunctions, i = e.core.sourceDisplayFacade,
        r = e.resolve;
    ...
    function Q(e) {
      ...
      n = (t = e).core.eventsDispatcher, o = t.props, n.dispatch = function(e) {
        ...
        var t = e.core, n = t.globalEventsController, o = t.windowResizeActioner, i = e.fs, r = e.resolve, s = r(U),
          a = r(V), c = r(G);
        ...
        var t = e.componentsServices, n = e.core, o = n.slideIndexChanger, i = n.sourceDisplayFacade,
          r = n.stageManager, s = e.elements, a = s.smw, c = s.sourceAnimationWrappers, l = e.isl, u = e.stageIndexes,
          d = e.sws;
    ...
    function Z(e) {
      ...
      e.open = function() {
        var n = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0, i = m.previous, a = m.current,
          d = m.next;
