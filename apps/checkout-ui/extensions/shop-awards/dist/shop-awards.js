...
${errorInfo.componentStack}`);
  ...
  // extensions/shop-awards/src/Checkout.tsx
  ...
  function Extension() {
    ...
    const [shopAwards, setShopAwards] = (0, import_react14.useState)([]);
    appMetafields.subscribe((metafields) => {
      const awards = JSON.parse(metafields[0].metafield.value);
      setShopAwards(awards);
    });
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockLayout2, { rows: "auto", spacing: "extraLoose", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(View2, { inlineAlignment: "center", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { size: "extraLarge", emphasis: "bold", children: "Multi Award Winning Mattress" }) }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(InlineLayout2, { columns: "fill", spacing: "loose", blockAlignment: "center", inlineAlignment: "center", children: shopAwards.map((i) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(View2, { overflow: "hidden", cornerRadius: "large", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Image2, { source: i.src }) })) })
    ] });
  }
})();
//# sourceMappingURL=shop-awards.js.map
