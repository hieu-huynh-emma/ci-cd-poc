...
${errorInfo.componentStack}`);
  ...
  // node_modules/.pnpm/@shopify+ui-extensions-react@2024.7.0_@shopify+ui-extensions@2024.7.0_react-reconciler@0.29.0_react@18.3.1/node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/hooks/cart-line-target.mjs
  ...
  function getLineItem(_0) {
    return __async(this, arguments, function* ({ cartLine, query }) {
      ...
      const originalPrice = (_b = (_a = data == null ? void 0 : data.node) == null ? void 0 : _a.compareAtPrice.amount) != null ? _b : 0;
  ...
  function getSettings(extensionSettings) {
    const appearance = extensionSettings.apperance || "subdued", inlineAlignment = extensionSettings.alignment === "right" ? "end" : "start", fontSize = extensionSettings.fontSize || "base", content = extensionSettings.message || "On sale. Originally", strikethrough = extensionSettings.isShowStrikethrough ? "deletion" : void 0, isShowPercentage = extensionSettings.isShowPercentage;
  ...
  function Extension() {
    ...
    (0, import_react13.useEffect)(() => __async(this, null, function* () {
      ...
      const totalDiscounts = Math.max(0, originalPrice - price), priceCurrency = formatter.format(price), originalPriceCurrency = formatter.format(originalPrice), totalDiscountsCurrency = formatter.format(totalDiscounts);
      setPricing({
        price,
        priceCurrency,
        originalPrice,
...
//# sourceMappingURL=compare-at-price.js.map
