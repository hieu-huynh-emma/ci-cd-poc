...
${errorInfo.componentStack}`);
  ...
  // node_modules/.pnpm/@shopify+ui-extensions-react@2024.7.0_@shopify+ui-extensions@2024.7.0_react-reconciler@0.29.0_react@18.3.1/node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/hooks/cart-lines.mjs
  ...
  // node_modules/.pnpm/@shopify+ui-extensions-react@2024.7.0_@shopify+ui-extensions@2024.7.0_react-reconciler@0.29.0_react@18.3.1/node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/hooks/discounts.mjs
  ...
  // extensions/total-savings/src/TotalSavings.tsx
  var import_react13 = __toESM(require_react());
  var import_jsx_runtime4 = __toESM(require_jsx_runtime());
  var TotalSavings_default = reactExtension("purchase.checkout.block.render", () => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Extension, {}));
  function getOrderPriceBreakdown(_0) {
    return __async(this, arguments, function* ({ cartLines, query, i18n, totalDiscountedAmount }) {
      ...
      function computePricing(lineItems2) {
        ...
        const priceCurrency = formatter.format(price), originalPriceCurrency = formatter.format(originalPrice), totalDiscountsCurrency = formatter.format(totalDiscounts);
        return {
          price,
          priceCurrency,
          originalPrice,
  ...
  function getLineItem(_0) {
    return __async(this, arguments, function* ({ cartLine, query }) {
      ...
      const pricePerUnit = (_c = (_b = (_a = data == null ? void 0 : data.node) == null ? void 0 : _a.price) == null ? void 0 : _b.amount) != null ? _c : 0, price = pricePerUnit * quantity, originalPricePerUnit = (_f = (_e = (_d = data == null ? void 0 : data.node) == null ? void 0 : _d.compareAtPrice) == null ? void 0 : _e.amount) != null ? _f : 0, originalPrice = originalPricePerUnit * quantity;
  ...
  function getSettings(extensionSettings) {
    const inlineAlignment = extensionSettings.alignment === "right" ? "end" : "start", content = extensionSettings.message || "You save";
    return { inlineAlignment, content };
  }
  var getDiscountedAmount = (discountAllocations = []) => discountAllocations.reduce((r, { discountedAmount: { amount } }) => r += amount, 0);
  function getTotalDiscountAllocations(cartDiscountAllocations, cartLines) {
  ...
  function Extension() {
    ...
    const [pricing, setPricing] = (0, import_react13.useState)({ price: 0, originalPrice: 0 });
    (0, import_react13.useEffect)(() => __async(this, null, function* () {
      const priceBreakdown = yield getOrderPriceBreakdown({ cartLines, query, i18n, totalDiscountedAmount });
      setPricing(priceBreakdown);
    }), [query]);
    const { inlineAlignment, content } = settings;
    return pricing.totalDiscounts ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(InlineLayout2, { columns: "fill", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(View2, { padding: "none", inlineAlignment, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
      Text2,
      {
        size: "medium",
        appearance: "critical",
...
//# sourceMappingURL=total-savings.js.map
